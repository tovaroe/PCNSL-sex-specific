function [H_count, DAB_count] = CD45ro_counting(image, showfigs)
%CD45RO_COUNTING Returns the numbers of CD45ro-stained and Haematoxylin-stained cells    
%
...
%   cells (DAB_count).
%
%   [...] = CD45ro_counting(IM) performs the cell counting on an image IM and
%   does not show figures for each segmentation step.
%
%   [...] = CD45ro_counting(IM, SHOWFIGS) shows figures for each segmentation
%   step if SHOWFIGS =/= 0.
%
%
...
res = segment_cells(image, ...
    'stain', 'H DAB 2', ...
    'phansalkar_k', [0.1 0.28], ...
    'otsuThresholdFactor', [1.2 0.65], ...
    'globalThreshold', [200 85], ...
    'cellSizeMin', [0 0], ...
